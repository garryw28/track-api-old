                                                                ...
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        ...
                                                                        <div style="text-align:left;font-family:'Roboto Condensed', Helvetica,Arial,sans-serif;font-size:16px;margin-bottom:0;color:#6f6f6f;line-height:135%;">
                                                                            ...
                                                                            <p>To start use our service, please confirm and verify your email address by clicking Confirmation button below.</p> 
                                                            ...
                                                            border:solid 1px #efefef;">
                                                                <tr>
                                                                    <td align="center" valign="middle" class="buttonContent" style="padding-top:10px;padding-bottom:10px;padding-right:5px;padding-left:5px;">
                                                                        <a style="color:#FFFFFF;text-decoration:none;font-family:'Roboto Condensed', Helvetica,Arial,sans-serif;font-size:16px; font-weight:400;line-height:135%;" href="<?php echo env('FE_URL').'/pages/activate-password/'.$token; ?>" target="_blank">Confirmation</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
