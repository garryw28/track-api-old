                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        ...
                                                                        <h3 style="color:#3f3f3f;line-height:125%;font-family:'Roboto Condensed', Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:20px;text-align:left;">Welcome to Astra FMS Customer Dashboard</h3>
                                                                        <div style="text-align:left;font-family:'Roboto Condensed', Helvetica,Arial,sans-serif;font-size:16px;margin-bottom:0;color:#6f6f6f;line-height:135%;">To reset your password, please confirm and verify your new password by clicking Change Password button below.
                                                                            <small><sup style="color: red;">*</sup> This link expires in 30 minutes</small>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                            	...
                                            	<table border="0" cellpadding="30" cellspacing="0" width="600" class="flexibleContainer">
                                                	<tr>
                                                    	<td style="padding-top:0;" align="center" valign="top" width="600" class="flexibleContainerCell">
                                                            ...
                                                            <!-- CONTENT TABLE // -->
                                                            <table border="0" cellpadding="0" cellspacing="0" width="30%" class="emailButton" style="background-color: #1f419b; border-radius:4px; -ms-box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;
                                                            -o-box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;
                                                            box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;
                                                            border:solid 1px #efefef;">
                                                                <tr>
                                                                    <td align="center" valign="middle" class="buttonContent" style="padding-top:10px;padding-bottom:10px;padding-right:5px;padding-left:5px;">
                                                                        <a style="color:#FFFFFF;text-decoration:none;font-family:'Roboto Condensed', Helvetica,Arial,sans-serif;font-size:16px; font-weight:400;line-height:135%;" href="<?php echo env('FE_URL').'/pages/reset-password/'.$token; ?>" target="_blank">Change Password</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                                        ...
                                                                        <table class="flexibleContainerBoxNext" border="0" cellpadding="0" cellspacing="0" width="490" style="max-width:100%;">
                                                                            <tr>
                                                                                <td align="left" class="textContent">
                                                                                    ...
                                                                                    If you received this email but didn't register for Astra FMS Customer Dashboard account, please delete this email. Thank you.
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                                ...
                                                                                <td valign="top" class="textContent">
                                                                                    <div style="margin-bottom:0;margin-top:3px;margin-left:auto;margin-right:auto; display:table;">
                                                                                        <a href="#" style="display:bock; width:40px; height:40px; float:left; margin: 0 5px;">
                                                                                            <img src="facebook.png" alt="" style="border-radius:50%;  width:40px; border:solid 2px #efefef; -ms-box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;-o-box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;"/>
                                                                                        </a>
                                                                                        <a href="#" style="display:bock; width:40px; height:40px; float:left; margin: 0 5px;">
                                                                                            <img src="twitter.png" alt="" style="border-radius:50%;  width:40px; border:solid 2px #efefef; -ms-box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;-o-box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;"/>
                                                                                        </a>
                                                                                        <a href="#" style="display:bock; width:40px; height:40px; float:left; margin: 0 5px;">
                                                                                            <img src="google.png" alt="" style="border-radius:50%;  width:40px; border:solid 2px #efefef; -ms-box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;-o-box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;"/>
                                                                                        </a>
                                                                                        <a href="#" style="display:bock; width:40px; height:40px; float:left; margin: 0 5px;">
                                                                                            <img src="instagram.png" alt="" style="border-radius:50%;  width:40px; border:solid 2px #efefef; -ms-box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;-o-box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;box-shadow: rgba(147, 147, 147, 0.1) 0 1px 15px 1px;"/>
                                                                                        </a>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td valign="top" class="textContent">
                                                                                    <div style="margin-bottom:0;margin-top:30px;margin-left:auto;margin-right:auto; display:table;">
                                                                                        <a href="#" style="display:bock;margin:0 5px;"><img src="ios.png" alt="" width="150"/></a>
                                                                                        <a href="#" style="display:bock;margin:0 5px;"><img src="android.png" alt="" width="150"/></a>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
